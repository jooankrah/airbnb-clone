...
function Header() {
    return (
        <header className="sticky top-0 bg-white z-50 py-3 px-5 shadow-md">
            <div className="max-w-[1760px] mx-auto px-8 sm:px-8 md:px-16 lg:px-16 xl:px-16 2xl:px-16 grid grid-cols-3"> 
                {/** left div */}
                ...
                {/**middle div */}
                <div className='flex justify-between items-center md:border-2 rounded-full py-2 px-2'>
